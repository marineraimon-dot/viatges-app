...
1 € ≈ 63 ₱ (pesos filipins). Preus consultats juliol 2026.`,
  ...
  // ── VOLS I TRANSPORT ──
  transportLegs: [
    { id: 'leg-ey114', type: 'flight_intl', variantId: null, code: 'EY114', route: 'Barcelona (BCN) → Abu Dhabi (AUH)', dateDep: '2026-07-28', timeDep: '22:30', dateArr: '2026-07-29', timeArr: '07:05', provider: 'Etihad Airways', pricePerPerson: 1000, priceTotal: 7000, status: 'reservat', bookingRef: '8OVZIF / 8OZ2QI', bookingLink: '', notes: 'Anada · nit al vol. 1 canvi de data gratuït per bitllet (bitllets emesos des del 6/3/2026, viatge fins 31/3/2027).', attachments: FIL_FLIGHT_ATTACHMENTS },
    { id: 'leg-ey446', type: 'flight_intl', variantId: null, code: 'EY446', route: 'Abu Dhabi (AUH) → Manila (MNL)', dateDep: '2026-07-29', timeDep: '09:00', dateArr: '2026-07-29', timeArr: '22:00', provider: 'Etihad Airways', pricePerPerson: null, priceTotal: null, status: 'reservat', bookingRef: '8OVZIF / 8OZ2QI', bookingLink: '', notes: 'Arribada Manila 29 jul nit.', attachments: FIL_FLIGHT_ATTACHMENTS },
    { id: 'leg-ey441', type: 'flight_intl', variantId: null, code: 'EY441', route: 'Manila (MNL) → Abu Dhabi (AUH)', dateDep: '2026-08-11', timeDep: '19:05', dateArr: '2026-08-12', timeArr: '00:35', provider: 'Etihad Airways', pricePerPerson: null, priceTotal: null, status: 'reservat', bookingRef: '8OVZIF / 8OZ2QI', bookingLink: '', notes: 'Cal ser a Manila el dia 10 per garantir la connexió.', attachments: FIL_FLIGHT_ATTACHMENTS },
    { id: 'leg-ey111', type: 'flight_intl', variantId: null, code: 'EY111', route: 'Abu Dhabi (AUH) → Barcelona (BCN)', dateDep: '2026-08-12', timeDep: '02:30', dateArr: '2026-08-12', timeArr: '07:35', provider: 'Etihad Airways', pricePerPerson: null, priceTotal: null, status: 'reservat', bookingRef: '8OVZIF / 8OZ2QI', bookingLink: '', notes: 'Arribada BCN 12 ago.', attachments: FIL_FLIGHT_ATTACHMENTS },

    { id: 'leg-mnl-pps', type: 'flight_domestic', variantId: null, code: '', route: 'Manila (MNL) → Puerto Princesa (PPS)', dateDep: '2026-07-30', timeDep: '~16:30', dateArr: '2026-07-30', timeArr: '', provider: 'Cebu Pacific / PAL', pricePerPerson: 55, priceTotal: 385, status: 'reservat', bookingRef: 'RKF4HW', bookingLink: 'https://www.cebupacificair.com/', notes: 'Factura Cebu Pacific: 33.172,72 ₱ per 7 passatgers (inclou taxes).', attachments: [{ filename: 'VOLS MANILA-PUERTO PRINCESA.pdf', path: DOC('vols-interns/VOLS MANILA-PUERTO PRINCESA.pdf') }] },
